...
#num = input("Enter a number. This will print the prime numbers up to that number: ")
...
def find_prime(num):
	...
	try:
		...
		print("ValueError: number input must be an integer")
		exit(1)

	try:
		if num <= 1:
			raise ValueError("ValueError: number must be greater than 1")
